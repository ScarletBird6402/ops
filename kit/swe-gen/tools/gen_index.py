...
PUB = {'A12','A13','C10','C11','C17','C18','D2',
       ...
       'K3','L1','L3','M12','I14','I16','D12','C16','C15','K13','C4','D1','B2','P4','Q3','I2','E17','E24','I24','I27'}  # 2026-09-16 4주차 20건(세션1 K3~K13 / 세션2 C4~I27)

# 최근 추가 (코드, 제목, 날짜) — 최신순, 최대 10
RECENT = [('I27','정규화 정본과 표현형 — 경계에서 한 번','2026-09-16'),
